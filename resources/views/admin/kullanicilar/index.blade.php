...
@section('content')
    <div style="float:left;margin: 15px 0 15px 0"><a href="{{route('yonetici.ekle')}}" class="btn btn-success">Yoneticiler</a></div>
    <div class="widget-box">
        ...
        <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
                ...
                <tbody>
                @foreach($kullanicilar as $i=> $kullanici)
                    <tr class="gradeX">
                        ...
                        <td>
                            <img border="0" width="50" height="30" src="/{{$kullanici->avatar}}">
                        </td>
                        <td class="center">
